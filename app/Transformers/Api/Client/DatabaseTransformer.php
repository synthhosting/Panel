...
class DatabaseTransformer extends BaseClientTransformer
{
     ...
     */
    public function handle(Encrypter $encrypter, HashidsInterface $hashids, DatabaseManagementService $managementService)
    {
    ...
    public function transform(Database $model): array
    {
        ...
        $size = $this->managementService->getDatabaseSize($model);
