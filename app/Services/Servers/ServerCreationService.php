...
class ServerCreationService
{
    ...
    public function handle(array $data, DeploymentObject $deployment = null): Server
    {
        ...
        $server = $this->connection->transaction(function () use ($data, $eggVariableData) {
            ...
            // Create allocations with auto allocation adder
			$auto_allocation_ids = $this->autoAllocationService->handle($server, $eggVariableData);
			if ($auto_allocation_ids != false) {
				isset($data['allocation_additional']) 
					? $data['allocation_additional'] = array_merge($data['allocation_additional'], $auto_allocation_ids['allocations']) 
					: $data['allocation_additional'] = $auto_allocation_ids['allocations'];
				$eggVariableData = $auto_allocation_ids['eggs'];
			}
