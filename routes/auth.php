...
// These routes are defined so that you can log in or register account with socialite.
Route::get('/login/{provider}', [Auth\SocialiteController::class, 'redirectToProvider']);
Route::get('/login/{provider}/redirect', [Auth\SocialiteController::class, 'handleProviderCallback']);
