...
const Select = styled.select<Props>`
    ${tw`shadow-none block p-3 pr-8 rounded-2xl border w-full text-sm transition-colors duration-150 ease-linear`};
    ...
    ${(props) =>
        ...
        css`
            ${tw`bg-helionix-color3 border-helionix-color4`};
