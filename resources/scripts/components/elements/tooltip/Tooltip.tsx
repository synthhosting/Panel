                ...
                {open && (
                    <motion.div
                        ...
                        {...getFloatingProps({
                            ref: floating,
                            className:
                                'bg-helionix-color3 text-sm text-gray-200 px-3 py-2 rounded-[10px] pointer-events-none max-w-[24rem]',
                            style: {
                                position: strategy,
                                top: `${y || 0}px`,
                                left: `${x || 0}px`,
                    ...
                    >
                        ...
                        {props.arrow && (
                            <div
                                ...
                                className={classNames('absolute bg-helionix-color3 w-3 h-3', side)}
                            />
                        )}
                    </motion.div>
                )}
