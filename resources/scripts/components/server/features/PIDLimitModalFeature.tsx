            ...
            {isAdmin ? (
                <>
                    <div css={tw`mt-4 sm:flex items-center`}>
                        <LcIcon css={tw`pr-4`} icon={TriangleAlert} size={24} />
                    ...
                    <p css={tw`mt-4`}>
                        Increasing <code css={tw`font-mono bg-helionix-color4`}>container_pid_limit</code> in the wings
                        configuration, <code css={tw`font-mono bg-helionix-color4`}>config.yml</code>, might help resolve
                        this issue.
                    </p>
                    <p css={tw`mt-4`}>
                ...
                <>
                    <div css={tw`mt-4 sm:flex items-center`}>
                        <LcIcon css={tw`pr-4`} icon={TriangleAlert} size={24} />
                        <h2 css={tw`text-2xl mb-4`}>Possible resource limit reached...</h2>
                    </div>
                    <p css={tw`mt-4`}>
                    ...
                    <p css={tw`mt-4`}>
                        <code css={tw`font-mono bg-helionix-color4`}>
