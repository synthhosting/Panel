            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pUptimeFalse" value="0" name="uptime" checked>
                                <label for="pUptimeFalse"> Disbled </label>
                            </div>
                            <div class="radio radio-info radio-inline">
                                <input type="radio" id="pUptimeTrue" value="1" name="uptime">
                                <label for="pUptimeTrue"> Enabled </label>
                            </div>
                        </div>
                        <p class="text-muted small">If the uptime status is enabled, the node will be displayed on the uptime nodes page.</p>
                    </div>
                </div>
            </div>
        </div>
