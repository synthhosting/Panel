    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li><a href="{{ route('admin.nodes.view.downtime', $node->id) }}">Downtime</a></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label class="form-label"><span class="label" style="background: var(--button-primary);font-style:normal;color: var(--color-label);">Helionix</span> Uptime Status</label>
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pUptimeFalse" value="0" name="uptime" {{ (old('uptime', $node->uptime) == false) ? 'checked' : '' }}>
                                <label for="pUptimeFalse"> Disabled</label>
                            </div>
                            <div class="radio radio-warning radio-inline">
                                <input type="radio" id="pUptimeTrue" value="1" name="uptime" {{ (old('uptime', $node->uptime) == true) ? 'checked' : '' }}>
                                <label for="pUptimeTrue"> Enabled</label>
                            </div>
                        </div>
                        <p class="text-muted small">If the uptime is enabled, the node will be displayed on the uptime nodes page.</p>
                    </div>
                </div>
            </div>
        </div>
