                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="pImage" class="control-label"><span class="label" style="background: var(--button-primary);font-style:normal;color: var(--color-label);">Helionix</span> Egg image</label>
                                <input type="text" id="pImage" name="image" value="{{ old('image') }}" class="form-control" />
